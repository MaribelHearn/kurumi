...
module.exports = {
    define: function () {
        ...
        global.WAIFUS = {
            ...
            "fan": ["Marry Shepherd", "Corin Charite", "Phiased Pescar", "Mumumu Mikaboshi", "Janet Arc'Angelo", "Michel Sant'Angelo",
                "Iesua Nazarenus", "Elfin Mint", "Zankurou", "Kodama", "Aragami no Kusuko", "Momo Tobikura",
                "Saraka Sant'Angelo", "Tenmu Suitokuin", "An Yaezaki", "Mitama Magahara", "Riko Toone", "Hatsuna Magatsuji",
                "Ruri", "Suitenguu no Himemiko", "Nomi no Hanie", "Takenouchi no Tarumi", "Nameless R'lyeh Fairy",
                "Yamatoyo no Momohime", "Yamata no Yato", "Abe no Kiyohime", "Fabritis", "Iphonea", "Tobiko Takatou",
                "Shelia Lyrac", "Ichiyou Mochizuki", "Nezu Akitsu", "Fuma Mishandra", "Sengo Sanada", "Tamako Sant'Angelo",
                "Ami", "Rakuki Momosame", "Seiryuu Sya", "Kage Mimeima", "Rakukun Momosame", "Tensei Muriya", "Rika Kirigakure",
                "Konoha Susanomori", "Naruko Uzushima", "Miyo Amazu",  "Tsubame Minazuki", "Kasumi Shindou", "Megumi Yaobi",
                "Mikoto Yaobi", "Otohime Kanpukugu", "Nix", "Sachiko Kobayashi", "Sayuri Katsuki", "Mitsuha Kura",
                "Akami Kurotsuka", "Ryouko", "Soujouko", "Tsukiko Seida", "Suzuka Mikami", "Kagemo", "Yukiko Tsubaki",
                "Meimei", "Saruta Mitama", "Uzume Mitama", "Touko Ugajin", "Shirigai no Mamo", "Azure Swirl", "Jiriri Kim",
                "Sakkagumi Yamomo", "Saga Kuramu", "Iroha Tsubasa", "Hammon", "Umehime Kazarashi", "Jami Wang",
                "Padma Raksasa", "Ummu Tzumazaru", "Nusakoro Pandora", "Kazue", "Aimi Sagigamori", "Watatsuki no Itsuhime",
                "Theone Philips", "Aiguillion Gifttaenzer", "Toyomi Endou", "Homura Meiyou", "Mitsuru Narukami",
                "Ayame Azamine", "Nami Amamoto", "Hikawa Motoharu", "Ariwara no Miyabiko", "Ren Hitotachi",
                "Ten Hitotachi", "Snow Cordle", "Sekito Umakakeba", "Magura Togura", "Kikyou Kabutozukamori",
                "Shuuu Yasogami", "Megumu Garyuuen", "Suzume", "Mirerym", "Kousen Hoshikusa"],
            "lenen": ["Yabusame Houlen", "Tsubakura Enraku", "Kurohebi", "Aoji Shitodo", "Tsurubami Senri (disguised as Tsubakura Enraku)",
        ...
        global.flag = function (country) {
            ...
            if (COUNTRIES.hasOwnProperty(country)) {
                ...
                country = (COUNTRIES.hasOwnProperty(alt) ? COUNTRIES[alt].code : country);
            }
